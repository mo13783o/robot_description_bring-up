...
// Ticks per full wheel revolution (calibrate for your motors)
const long  TICKS_PER_REV_L = 875;
const long  TICKS_PER_REV_R = 798;

// Physical dimensions (metres)
const float WHEEL_RADIUS = 0.075f;   // 15 cm diameter → 7.5 cm radius
...
//  Same comma-separated format as original File 1 for ROS compatibility.
...
//  Identical to original File 1 so the Python bridge needs no changes.
// ==========================================================================
